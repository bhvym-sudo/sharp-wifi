...
{
 var str=new Array();
 str[0]=new Array(101,"上下行带宽不允许同时为空，请重新输入。");
...
function btnApply()
{
 ...
 if( (getObj("us_cfg").value=="")&&(getObj("ds_cfg").value=="") )
 {
  var msg = getmsg(101);
  alert(msg);
  getObj("us_cfg").focus();
 ...
 <DIV align="left" style="padding-left:20px; padding-top:5px">
  <form id="form" action=/boaform/admin/formBandWidth method=POST name="form">
   ...
   <table border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
     <td width="180">上行带宽限制(留白表示不限制)&nbsp;</td>
     <td><input type="text" id="us_cfg" name="us_cfg" size="18">&nbsp;kbps</td>
    </tr>
    <tr>
     <td width="180">下行带宽限制(留白表示不限制)&nbsp;</td>
     <td><input type="text" id="ds_cfg" name="ds_cfg" size="18">&nbsp;kbps</td>
    </tr>
   </table>
   <hr align="left" class="sep" size="1" width="90%">
