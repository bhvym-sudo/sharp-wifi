...
<blockquote>
<DIV align="left" style="padding-left:20px; padding-top:5px">
	<h2><font color="#0000FF">端口鏡像配置，网线接LAN1口</font></h2>(临时配置，重启后失效)
	<form action=/boaform/formpktmirrorEnable method=POST name="pktmirrorEnable">
		<table border="0" cellspacing="4" width="500">
			<tr><td>
     			<input type="radio" value="0" name="pktmirroren"  onClick="onClickMirrorEnable()">鏡像PON口
				<input type="radio" value="1" name="pktmirroren" onClick="onClickMirrorEnable()">鏡像PON及CPU口
			</td></tr>
			<input type="hidden" value="/bd/vermod.asp" name="submit-url">
		</table>
	</form>
...
<DIV align="left" style="padding-left:20px; padding-top:5px">
  ...
  <form action=/boaform/formPingWAN method=POST>
    <table border="0" cellspacing="4" width="500">
      <tr><td>
        <input type="checkbox" <% checkWrite("enable_ping_wan"); %> name="ping_wan" onClick="submit()"> 开启
      </td></tr>
      <input type="hidden" value="/bd/vermod.asp" name="submit-url">
    </table>
  </form>
...
<DIV align="left" style="padding-left:20px; padding-top:5px">
  ...
  <form action=/boaform/admin/debug_e8c_set method=POST>
    <table border="0" cellspacing="4" width="500">
	<tr><td>
        <input type="checkbox" <%voip_e8c_get("sip_debug");%> name="sip_debug" onClick="submit()"> 开启
    </td></tr>
    </table>
...
<DIV align="left" style="padding-left:20px; padding-top:5px">
  ...
  <form action=/boaform/admin/debug_e8c_set method=POST>
	...
	<input type="button" class="button" name="btnDown" value="电压启用" onClick="submit()">
      <input type="hidden" value="/bd/vermod.asp" name="submit-url">
  </form>
</DIV>
</blockquote>
