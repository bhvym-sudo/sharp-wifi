...
function DisplayTxRate(v_index, band, auto, txrate, rf_num, channel_width)
{
 ...
 if(band & 64){
  ...
  for (i=0; i<=vht_num; i++) {
    ...
    if (txrate == rate)
     defidx = idx;
    if(channel_width!=0 || (i!=9 && i!=19 && i!=29))//no MCS9 when 20M
    {
...
<div class="page">
 <div class="simplebox">
  <table class="tabletitle">
   <tr>
    <td><% multilang("231" "LANG_WLAN_MULTIPLE_BSSID_SETTINGS"); %></td>
   </tr>
  </table>
...
<!--
 <tr>
  <td><b><% multilang("232" "LANG_BLOCKING_BETWEEN_VAP"); %>:</b></td>
  <td><input type="radio" name="mbssid_block" value="disable" ><% multilang("233" "LANG_DISABLE"); %>&nbsp;&nbsp;
  <input type="radio" name="mbssid_block" value="enable" ><% multilang("234" "LANG_ENABLE"); %></td>
 </tr>
-->
<table class="tabledata">
       ...
       <th>SSID</th>
       <th<% checkWrite("wlan_qtn_hidden_function"); %>>Data Rate</th>
       <th>Broadcast SSID</th>
       <th>WMM</th>
       <th>Relay Blocking</th>
       <td class="table_item" id="wl_limit_stanum_div" align="center" style="display:none"><% multilang("135" "LANG_STA_NUMBER"); %></td>
...
<tr>
 ...
 <td height="25" align="center" bgcolor="#FFFFFF">
  <script type="text/javascript">
   ...
   UpdateVirtualStatus(document.MultipleAP, 1);
  </script>
 </td>
 ...
 <td height="25" align="center" bgcolor="#FFFFFF">
  ...
  <input class="submit-button" type="button" value="Show" name="aclient1" onClick="open_client_table(1);">
      </td>
 <td id="wl_txbf_div1" style="display:none;white-space:nowrap" align="center" bgcolor="#FFFFFF">
  <select name=wl_txbf_ssid1 onChange="UpdateTxBf(document.MultipleAP, 1)">
   <option value="0">Disabled</option>
   <option value="1">Enabled</option>
  </select>
 </td>
 <td id="wl_txbfmu_div1" style="display:none;white-space:nowrap" align="center" bgcolor="#FFFFFF">
  <select name=wl_txbfmu_ssid1>
   <option value="0">Disabled</option>
   <option value="1">Enabled</option>
  </select>
 </td>
 <td id="wl_mc2u_div1" style="display:none;white-space:nowrap" align="center" bgcolor="#FFFFFF">
...
<tr>
 ...
 <td height="25" align="center" bgcolor="#FFFFFF">
  <script type="text/javascript">
   ...
   UpdateVirtualStatus(document.MultipleAP, 2);
  </script>
 </td>
 <td <% checkWrite("wlan_qtn_hidden_function"); %> height="25" align="center" bgcolor="#FFFFFF">
 ...
 <td height="25" align="center" bgcolor="#FFFFFF">
  <input class="submit-button" type="button" value="Show" name="aclient2" onClick="open_client_table(2);">
      </td>
 <td id="wl_txbf_div2" style="display:none;white-space:nowrap" align="center" bgcolor="#FFFFFF">
  <select name=wl_txbf_ssid2 onChange="UpdateTxBf(document.MultipleAP, 2)">
   <option value="0">Disabled</option>
   <option value="1">Enabled</option>
  </select>
 </td>
 <td id="wl_txbfmu_div2" style="display:none;white-space:nowrap" align="center" bgcolor="#FFFFFF">
  <select name=wl_txbfmu_ssid2>
   <option value="0">Disabled</option>
   <option value="1">Enabled</option>
  </select>
 </td>
 <td id="wl_mc2u_div2" style="display:none;white-space:nowrap" align="center" bgcolor="#FFFFFF">
...
<tr>
 ...
 <td height="25" align="center" bgcolor="#FFFFFF">
  <script type="text/javascript">
   ...
   UpdateVirtualStatus(document.MultipleAP, 3);
  </script>
 </td>
 <td <% checkWrite("wlan_qtn_hidden_function"); %> height="25" align="center" bgcolor="#FFFFFF">
 ...
 <td height="25" align="center" bgcolor="#FFFFFF">
  <input class="submit-button" type="button" value="Show" name="aclient3" onClick="open_client_table(3);">
      </td>
 <td id="wl_txbf_div3" style="display:none;white-space:nowrap" align="center" bgcolor="#FFFFFF">
  <select name=wl_txbf_ssid3 onChange="UpdateTxBf(document.MultipleAP, 3)">
   <option value="0">Disabled</option>
   <option value="1">Enabled</option>
  </select>
 </td>
 <td id="wl_txbfmu_div3" style="display:none;white-space:nowrap" align="center" bgcolor="#FFFFFF">
  <select name=wl_txbfmu_ssid3>
   <option value="0">Disabled</option>
   <option value="1">Enabled</option>
  </select>
 </td>
 <td id="wl_mc2u_div3" style="display:none;white-space:nowrap" align="center" bgcolor="#FFFFFF">
...
<br><br>
 <input type="hidden" value="/mobile/wlmultipleap_mobile.asp" name="submit-url">
 <input class="submit-button" type="submit" value=<% multilang("138" "LANG_APPLY_CHANGES"); %> name="save" onClick="return saveChanges(document.MultipleAP, wlan_idx)">&nbsp;&nbsp;
 <input class="submit-button" type="button" value=<% multilang("208" "LANG_RESET"); %> name="reset1" onClick="click_reset();">&nbsp;&nbsp;
<br><br>
