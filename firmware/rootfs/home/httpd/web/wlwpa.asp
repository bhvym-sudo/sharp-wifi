<%SendWebHeadStr(); %>
<title><% multilang("185" "LANG_WLAN_SECURITY_SETTINGS"); %></title>
...
<blockquote>
<!-- <h2 class="page_title"><% multilang("185" "LANG_WLAN_SECURITY_SETTINGS"); %></h2> -->
<form action=/boaform/admin/formWlEncrypt method=POST name="formEncrypt">
<div class="intro_main ">
 <p class="intro_title"><% multilang("185" "LANG_WLAN_SECURITY_SETTINGS"); %></p><br>
 <p class="intro_content"><% multilang("186" "LANG_PAGE_DESC_WLAN_SECURITY_SETTING"); %></p><br>
</div>
<div class="data_common data_common_notitle" id="wlan_security_table" style="display:none">
<table>
 <input type=hidden name="wlanDisabled" value=<% wlanStatus(); %>>
 <input type=hidden name="isNmode" value=0 >
 <tr>
        <th width=40%><% multilang("130" "LANG_SSID"); %> <% multilang("274" "LANG_TYPE"); %>:</th>
  <td>
 ...
 <tr>
  <th width=40%><% multilang("187" "LANG_ENCRYPTION"); %>:</th>
 ...
 <table id="setting_wep" style="display:none">
  ...
  <tr>
   <th width=40%><% multilang("191" "LANG_KEY_LENGTH"); %>:</th>
   <td>
  ...
  <tr>
   <th width=40%><% multilang("192" "LANG_KEY_FORMAT"); %>:</th>
   <td>
 ...
 <table id="setting_wpa" style="display:none">
  ...
  <tr id="show_dotIEEE80211W" style="display:none">
   <th width=40%><% multilang("201" "LANG_IEEE_802_11W"); %>:</th>
   <td>
  ...
  <tr id="show_sha256" style="display:none">
   <th width=40%><% multilang("202" "LANG_SHA256"); %>:</th>
   <td>
    <input name="sha256" type="radio" value="0"><% multilang("233" "LANG_DISABLE"); %>
    <input name="sha256" type="radio" value="1"><% multilang("234" "LANG_ENABLE"); %>
   </td>
  </tr>
  <tr id="show_wpa_cipher" style="display:none">
   <th width=40%>WPA <% multilang("195" "LANG_CIPHER_SUITE"); %>:</th>
   <td>
  ...
  <tr id="show_wpa2_cipher" style="display:none">
   <th width=40%>WPA2 <% multilang("195" "LANG_CIPHER_SUITE"); %>:</th>
   <td>
  ...
  <tr id="show_wpa_gk_rekey" style="display:none">
   <th width=40%><% multilang("196" "LANG_GROUP_KEY_UPDATE_TIMER"); %>:</th>
   <td><input type="text" name="gk_rekey" size="32" maxlength="10" value=""></td>
  </tr>
  <tr id="show_wpa_psk1" style="display:none">
   <th width=40%><% multilang("197" "LANG_PRE_SHARED_KEY_FORMAT"); %>:</th>
   <td>
  ...
  <tr id="show_wpa_psk2" style="display:none">
   <th width=40%><% multilang("198" "LANG_PRE_SHARED_KEY"); %>:</th>
 ...
 <table id="show_8021x_eap" style="display:none">
  <tr>
   <th width=40%>RADIUS <% multilang("89" "LANG_SERVER"); %> <% multilang("87" "LANG_IP_ADDRESS"); %>:</th>
   <td><input id="radius_ip" name="radiusIP" size="16" maxlength="15" value="0.0.0.0"></td>
  </tr>
  <tr>
   <th width=40%>RADIUS <% multilang("89" "LANG_SERVER"); %> <% multilang("199" "LANG_PORT"); %>:</th>
   <td><input type="text" id="radius_port" name="radiusPort" size="5" maxlength="5" value="1812"></td>
  </tr>
  <tr>
   <th width=40%>RADIUS <% multilang("89" "LANG_SERVER"); %> <% multilang("65" "LANG_PASSWORD"); %>:</th>
