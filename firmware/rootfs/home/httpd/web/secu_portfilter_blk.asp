...
<SCRIPT>
var protos = new Array("(None)", "TCP/UDP", "TCP", "UDP", "ICMP");
var ipv6_protos = new Array("(None)", "TCP/UDP", "TCP", "UDP", "ICMPV6");
var rcs = new Array();
...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" alink="#000000" link="#000000" vlink="#000000" onLoad="on_init();">
 ...
 <div class="intro_main ">
  <p class="intro_title"><% multilang("489" "LANG_UPSTREAM"); %> <% multilang("2697" "LANG_BLACK_LIST"); %> <% multilang("224" "LANG_CONFIGURATION"); %></p>
  <p class="intro_content"><% multilang("3061" "LANG_BLACK_LIST_NOTE"); %></p>
 </div>
 ...
 <div class="btn_ctl">
  <input type="button" class="link_bg" onClick="location.href='secu_portfilter_blkadd.asp';" value="<% multilang("207" "LANG_ADD"); %>">
