...
<blockquote>
<!-- <h2 class="page_title"><% multilang("231" "LANG_WLAN_MULTIPLE_BSSID_SETTINGS"); %></h2> -->
<div class="intro_main ">
 <p class="intro_title"><% multilang("231" "LANG_WLAN_MULTIPLE_BSSID_SETTINGS"); %></p><br>
</div>
...
<input type="hidden" value="/admin/wlmultipleap.asp" name="submit-url">
  <input class="link_bg" type="submit" value=<% multilang("138" "LANG_APPLY_CHANGES"); %> name="save" onClick="return saveChanges(document.MultipleAP, wlan_idx)">&nbsp;&nbsp;
  <input class="link_bg" type="button" value=<% multilang("208" "LANG_RESET"); %> name="reset1" onClick="click_reset();">&nbsp;&nbsp;
</form>
</blockquote>
</body>
</html>
