<%SendWebHeadStr(); %>
<title><% multilang("125" "LANG_WLAN_BASIC_SETTINGS"); %></title>
<style>
.on {display:on}
.off {display:none}
</style>
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("125" "LANG_WLAN_BASIC_SETTINGS"); %></p><br>
 <p class="intro_content"> <% multilang("126" "LANG_PAGE_DESC_WLAN_BASIC_SETTING"); %></p><br>
</div>
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th width=40%><% multilang("127" "LANG_DISABLE_WLAN_INTERFACE"); %></th>
   <td><input type="checkbox" name="wlanDisabled" value=<% wlanStatus(); %> ONCLICK=updateState(document.wlanSetup)></td>
  </tr>
  <tr>
   <th width=40%><% multilang("128" "LANG_BAND"); %>:</th>
  ...
  <tr>
   ...
   <td><select size="1" name="mode" onChange="updateMode()"><% checkWrite("wlmode"); %></select>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <input type="button" value="<% multilang("141" "LANG_MULTIPLE_AP"); %>" name="multipleAP" onClick="showMultipleAP(document.wlanSetup, '/admin/wlmultipleap.asp')">
   </td>
  </tr>
  <tr>
   <th width=40%><% multilang("130" "LANG_SSID"); %>:</th>
   <td><input type=text name=ssid size="25" maxlength="32" value="<% getInfo("ssid"); %>"></td>
  </tr>
  <tr>
   <th width=40%><% multilang("3588" "LANG_CANCEL_BROADCAST"); %>:</th>
    <td><input type='checkbox' name='wlHide' ONCLICK="updateWlanBssid()" value=<% wlanssidhide(); %> ></td>
  </tr>
  <tr>
   <th width=40%><% multilang("3621" "LANG_BLOCK_RELAY"); %></th>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
   <th width=40%><% multilang("133" "LANG_CHANNEL_NUMBER"); %>:</th>
  ...
  <tr>
   <th width=40%><% multilang("136" "LANG_ASSOCIATED_CLIENTS"); %>:</th>
   <td><input type="button" value="<% multilang("137" "LANG_SHOW_ACTIVE_WLAN_CLIENTS"); %>" name="showMac" onClick="showMacClick('/boaform/admin/formWirelessTbl?submit-url=/admin/wlstatbl.asp&wlan_idx=<% checkWrite("wlan_idx"); %>')"></td>
  </tr>
  <!--
  <tr id="repeater_check" style="display:none">
   <th colspan=2>
  <input type="checkbox" name="repeaterEnabled" id="ck" value="ON" onClick="show()" <% checkWrite("repeaterEnabled"); %>
  ...
  <tr id="wifi_regdomain_demo">
   <th><% multilang("140" "LANG_REGDOMAIN"); %>:</th>
...
<div class="btn_ctl">
     ...
     <input class="link_bg" type="submit" value="<% multilang("138" "LANG_APPLY_CHANGES"); %>" name="save" onClick="return saveChanges()">
