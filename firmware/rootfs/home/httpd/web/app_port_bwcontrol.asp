...
var rules = new Array();
var act_idx = -1;
with(rules){<% initPagePortBWControl(); %>}
...
function on_init()
{
 ...
 for(var i = 0; i < rules.length; i++)
 {
  ...
  cell.innerHTML = "端口_"+rules[i].port;
  cell = row.insertCell(1);
  cell.innerHTML = rules[i].usBandwidth+" kbps";
  cell = row.insertCell(2);
  cell.innerHTML = rules[i].dsBandwidth+" kbps";
...
function addClick()
{
   var loc = "app_port_bwcontrol_add.asp";
...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" alink="#000000" link="#000000" vlink="#000000" onLoad="on_init();">
 <blockquote>
  <DIV align="left" style="padding-left:20px; padding-top:5px">
   <form id="form" action=/boaform/admin/formPortBandWidth method=POST name="form">
    <b>LAN端口带宽限制</b><br><br>
    ...
    <input type="hidden" name="submit-url" value="/app_port_bwcontrol.asp" >
   </form>
  </div>
 </blockquote>
</body>
