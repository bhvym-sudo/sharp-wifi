<%SendWebHeadStr(); %>
<title><% multilang("242" "LANG_WLAN_MESH_ACCESS_CONTROL"); %></title>
<script>
...
{
 if ( !confirm('<% multilang("1699" "LANG_CONFIRM_DELETE_ONE_ENTRY"); %>') ) {
  return false;
 }
 else{
  obj.isclick = 1;
...
<div class="intro_main ">
 <p class="intro_title"><% multilang("242" "LANG_WLAN_MESH_ACCESS_CONTROL"); %></p>
 <p class="intro_content"> <% multilang("243" "LANG_PAGE_DESC_WLAN_MESH_ACCESS_CONTROL"); %></p>
</div>
...
<div class="data_common data_common_notitle">
 <table>
  <tr>
     <th>
      <% multilang("129" "LANG_MODE"); %>: &nbsp;&nbsp;&nbsp;&nbsp;
     </th>
     <td>
   <select size="1" name="wlanAcEnabled" onclick="updateState()">
            <option value=0 ><% multilang("165" "LANG_DISABLED"); %></option>
            <option value=1 selected ><% multilang("205" "LANG_ALLOW_LISTED"); %></option>
            <option value=2 ><% multilang("206" "LANG_DENY_LISTED"); %></option>
          </select>
     </td>
     <td><input class="inner_btn" type="submit" value="<% multilang("138" "LANG_APPLY_CHANGES"); %>" name="setFilterMode" onClick="return on_submit(this)">&nbsp;&nbsp;</td>
  </tr>
 </table>
</div>
<div class="data_common data_common_notitle">
 <table>
  <tr><th><% multilang("90" "LANG_MAC_ADDRESS"); %>: </th>
   <td><input type="text" name="mac" size="15" maxlength="12">
       &nbsp;&nbsp;(ex. 00E086710502)</td></tr>
 </table>
</div>
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("207" "LANG_ADD"); %>" name="addFilterMac" onClick="return addClick(this)">&nbsp;&nbsp;
...
<div class="column">
 <div class="column_title">
  <div class="column_title_left"></div>
   <p><% multilang("209" "LANG_CURRENT_ACCESS_CONTROL_LIST"); %></p>
...
<div class="btn_ctl">
 <input class="link_bg" type="submit" value="<% multilang("210" "LANG_DELETE_SELECTED"); %>" name="deleteSelFilterMac" onClick="return deleteClick(this)">&nbsp;&nbsp;
 <input class="link_bg" type="submit" value="<% multilang("211" "LANG_DELETE_ALL"); %>" name="deleteAllFilterMac" onClick="return deleteAllClick(this)">&nbsp;&nbsp;&nbsp;
 <input type="hidden" value="/wlmeshACL.asp" name="submit-url">
 <input type="hidden" name="wlan_idx" value=<% checkWrite("wlan_idx"); %>>
 <input type="hidden" name="postSecurityFlag" value="">
</div>
