...
function btnApply()
{
 ...
 {
  if(rules[i].name == form.devname.value || rules[i].ext == form.mac.value)
  {
...
<body topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" alink="#000000" link="#000000" vlink="#000000">
 ...
 <DIV align="left" style="padding-left:20px; padding-top:5px">
  <form id="form" action=/boaform/admin/formRteMacFilter method=POST name="form">
   <b>添加路由模式下的MAC地址过滤规则</b><br><br><br>
   ...
   <input type="hidden" name="submit-url" value="/secu_macfilter_router.asp">
  </form>
 </div>
  </blockquote>
</body>
