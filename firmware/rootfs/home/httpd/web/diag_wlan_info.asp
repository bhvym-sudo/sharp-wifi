...
function on_init()
{
 ...
 for(var i = 0; i < rcs.length; i++)
 {
  ...
  cell.innerHTML = rcs[i].rx_pkt;
  cell = row.insertCell(2);
  cell.innerHTML = rcs[i].rx_err;
  cell = row.insertCell(3);
  cell.innerHTML = rcs[i].rx_drop;
  cell = row.insertCell(4);
  cell.innerHTML = rcs[i].rx_byte;
  cell = row.insertCell(5);
  cell.innerHTML = rcs[i].tx_pkt;
  cell = row.insertCell(6);
  cell.innerHTML = rcs[i].tx_err;
  cell = row.insertCell(7);
  cell.innerHTML = rcs[i].tx_drop;
  cell = row.insertCell(8);
  cell.innerHTML = rcs[i].tx_byte;
 }
}
