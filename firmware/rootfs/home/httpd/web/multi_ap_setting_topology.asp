...
<form action=/boaform/formMultiAP method=POST name="MultiAP">
 <div class="intro_main ">
  <p class="intro_title"><% multilang("255" "LANG_WLAN_EASY_MESH_TOPOLOGY"); %></p><br>
  <p class="intro_content"><% multilang("256" "LANG_WLAN_EASY_MESH_TOPOLOGY_DESC"); %></p><br>
 </div>
 <div id="other_div" class="data_common data_common_notitle" style="display:none">
 <table><tr><td>
 <% multilang("257" "LANG_WLAN_EASY_MESH_ROLE_IS_NOT_CONTROLLER"); %>
 </td></tr></table>
 </div>
 <div id="controller_div" class="data_common data_common_notitle" style="display:none">
 <table>
    <tr>
   <th><% multilang("258" "LANG_NETWORK_TOPOLOGY"); %>:</th>
  </tr>
  <tr>
  <td>
