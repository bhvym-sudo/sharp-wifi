...
<table>
    <tr><td><font size=2>
    <% multilang("186" "LANG_PAGE_DESC_WLAN_SECURITY_SETTING"); %>
    </font></td></tr>
...
<table>
 ...
 <input type=hidden name="isNmode" value=0 >
    <tr>
      <th><% multilang("130" "LANG_SSID"); %> <% multilang("274" "LANG_TYPE"); %>:</th>
 <td>
   <% SSID_select(); %>
   <!--
...
<table>
    <tr><td><hr size=1 noshade align=top></td></tr>
    <tr>
      <th><% multilang("187" "LANG_ENCRYPTION"); %>:&nbsp;
   ...
   <td colspan="2">
    <table>
      <tr>
       <th class="bgblue">802.1x <% multilang("188" "LANG_AUTHENTICATION"); %>:</th>
       <td class="bggrey">
    ...
    <tr id="show_wep_auth" style="display:none">
     <td colspan="2">
      <table>
        <tr>
        <th bgcolor="#FFFFFF" class="bgblue"><% multilang("188" "LANG_AUTHENTICATION"); %>:</th>
        <td class="bggrey">
  ...
  <td colspan="2">
   <table>
     ...
     <tr bgcolor="#FFFFFF">
     <th bgcolor="#FFFFFF" class="bgblue"><% multilang("191" "LANG_KEY_LENGTH"); %>:</th>
     <td class="bggrey">
    ...
    <tr bgcolor="#FFFFFF">
     <th bgcolor="#FFFFFF" class="bgblue"><% multilang("192" "LANG_KEY_FORMAT"); %>:</th>
     <td class="bggrey">
    ...
    <tr bgcolor="#FFFFFF">
     <th bgcolor="#FFFFFF" class="bgblue"><% multilang("193" "LANG_ENCRYPTION_KEY"); %>:</th>
     <td class="bggrey">
 ...
 <tr id="setting_wpa" style="display:none">
  <td colspan="2">
   <table>
    <tr>
     <th class="bgblue"><% multilang("194" "LANG_AUTHENTICATION_MODE"); %>:</th>
     <td class="bggrey">
    ...
    <tr id="show_wpa_cipher" style="display:none">
     <th class="bgblue">WPA <% multilang("195" "LANG_CIPHER_SUITE"); %>:</th>
     <td class="bggrey">
    ...
    <tr id="show_wpa2_cipher" style="display:none">
     <th class="bgblue">WPA2 <% multilang("195" "LANG_CIPHER_SUITE"); %>:</th>
     <td class="bggrey">
    ...
    <tr id="show_wpa_psk1" style="display:none">
     <th bgcolor="#FFFFFF" class="bgblue"><% multilang("197" "LANG_PRE_SHARED_KEY_FORMAT"); %>:</th>
     <td class="bggrey">
    ...
    <tr id="show_wpa_psk2" style="display:none">
     <th bgcolor="#FFFFFF" class="bgblue"><% multilang("198" "LANG_PRE_SHARED_KEY"); %>:</th>
 ...
 <tr id="show_1x_wep" style="display:none">
  <td colspan="2">
   <table>
    <tr>
     <th class="bgblue"><% multilang("191" "LANG_KEY_LENGTH"); %>:</th>
     <td class="bggrey">
 ...
 <tr id="show_8021x_eap" style="display:none">
  <td colspan="2">
   <table>
    <tr>
      <th bgcolor="#FFFFFF" class="bgblue">RADIUS <% multilang("89" "LANG_SERVER"); %> <% multilang("87" "LANG_IP_ADDRESS"); %>:</th>
      <td bgcolor="#FFFFFF" class="bggrey"><input id="radius_ip" name="radiusIP" size="16" maxlength="15" value="0.0.0.0"></td>
     </tr>
    <tr>
     <th bgcolor="#FFFFFF" class="bgblue">RADIUS <% multilang("89" "LANG_SERVER"); %> <% multilang("199" "LANG_PORT"); %>:</th>
     <td class="bggrey"><input type="text" id="radius_port" name="radiusPort" size="5" maxlength="5" value="1812"></td>
     </tr>
    <tr>
     <th class="bgblue">RADIUS <% multilang("89" "LANG_SERVER"); %> <% multilang("65" "LANG_PASSWORD"); %>:</th>
        ...
        <tr id="show_8021x_wapi" style="display:none">
                <td colspan="2">
                        <table>
                                ...
                                <th class="bgblue"><% multilang("200" "LANG_USE_LOCAL_AS_SERVER"); %>:</th>
                                <td class="bggrey">
                                <input type="checkbox" id="uselocalAS" name="uselocalAS" value="ON" onClick="show_wapi_ASip()">
                                </td></tr>
    <tr>
                                         <th bgcolor="#FFFFFF" class="bgblue">AS <% multilang("89" "LANG_SERVER"); %> <% multilang("87" "LANG_IP_ADDRESS"); %>:</th>
