...
function on_init()
{
 ...
 for (var i = 0; i < lanNetInfo.length; i++) {
  ...
  cell.innerHTML = lanNetInfo[i].model;
  ...
  cell.innerHTML = lanNetInfo[i].latestActiveTime;
  cell = row.insertCell(11);
  cell.innerHTML = lanNetInfo[i].latestInactiveTime;
 }
}
</SCRIPT>
</head>
   ...
   <br>
    <table id="lstLanHost" class="flat" border="1" cellpadding="1" cellspacing="1">
     <tr class="hdb" align="center" nowrap>
      ...
      <td width="100px">最新上线时间</td>
      <td width="100px">最新下线时间</td>
     </tr>
    </table>
  </form>
  </div>
